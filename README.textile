...
bc. "Your Symfony2 root folder"/src/Orderly/PaypalIpnBundle/OrderlyPayPalIpnBundle.php
...
bc. php app/console doctrine:schema:update --force
...
bc.. OrderlyPayPalIpnBundleEmail:
...
bc.. http://example.com/ipn-no-notification
...
bc. Orderly/PayPalIpnBundle/Controller/TwigNotificationEmailController.php

Example of usage without notyfication

bc. Orderly/PayPalIpnBundle/Controller/NoNotificationController.php
