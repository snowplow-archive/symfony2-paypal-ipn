...
class Configuration implements ConfigurationInterface
{
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode->children()
                ...
                ->scalarNode('pdttoken')->defaultValue(null)->end()
                ->scalarNode('proxy')->defaultValue(null)->end()
                ->booleanNode('debug')->defaultValue('%kernel.debug%')->end()
                ->scalarNode('sandbox_email')->defaultValue(null)->end()
                ...
                ->scalarNode('sandbox_pdttoken')->defaultValue(null)->end()
                ->variableNode('sandbox_pdtresponse')->defaultValue(null)->end()
